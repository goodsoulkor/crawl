...
# 브라우저 사이즈 지정
browser.set_window_size(1920, 1280)  # maximize_window(), minimize.window()
...
# 스크린 샷 저장1
browser.save_screenshot("./data/webss1.png")

# 스크린 샷 저장2
browser.get_screenshot_as_file("./data/webss2.png")
